...
begin
  if GetBasePotentialStr = 'Отсутствует' then Result := 0;
  if GetBasePotentialStr = 'Низкий' then Result := 1;
  if GetBasePotentialStr = 'Средний' then Result := 3;
  if GetBasePotentialStr = 'Высокий' then Result := 5;
end;
